...
//                .httpBasic();   //jisku bhi authentication add karra spring, unku HTTPBasic wala add kar
    ...
    }   //the details that comes from db it checks that encoded password with curr password (coming from login page,sec contxt holder) and ecoding it, if mathes then gets authenticated
